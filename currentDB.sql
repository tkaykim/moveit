...
CREATE TABLE public.classes (
  ...
  class_type character varying DEFAULT 'regular'::character varying CHECK (class_type::text = ANY (ARRAY['regular'::character varying::text, 'popup'::character varying::text, 'workshop'::character varying::text, 'REGULAR'::character varying::text, 'ONE_DAY'::character varying::text, 'PRIVATE'::character varying::text, 'RENTAL'::character varying::text])),
  thumbnail_url text,
