...
4. **등록 후**  
   ...
   - **체험 중** 구독이 생성되며, **구독 시작**에서 플랜·주기 선택 후 결제까지 테스트할 수 있습니다.
...
4. **「카드가 등록되었습니다.»** 메시지가 약 1초 정도 보임 → 자동으로 **구독/결제 관리** 페이지로 이동(`?card=ok`).
5. 구독/결제 관리 페이지가 **구독·카드 정보를 다시 불러와** 등록한 카드(카드사·마스킹 번호)와 **체험 중** 구독이 보임.
...
3. 등록이 완료되면 **체험 중** 구독이 생성되고, **구독 시작**에서 플랜·주기 선택 후 결제까지 진행 가능.
