    ...
    <div className="space-y-6" data-onboarding="page-revenue-0">
      ...
      {refundTarget && (
        <RefundModal
          ...
          fallbackTicketName={refundTarget.ticket_name || refundTarget.tickets?.name}
          fallbackUserName={refundTarget.users?.name || refundTarget.users?.nickname}
