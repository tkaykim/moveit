  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-950 flex flex-col">
      <nav className="h-14 flex items-center px-4 border-b border-neutral-200 dark:border-neutral-800">
        <Link href="/intro" className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-primary">
          ← 입점 제안
        </Link>
      </nav>
      <main className="flex-1 flex flex-col items-center justify-center px-6 max-w-md mx-auto">
        <div className="w-16 h-16 rounded-2xl bg-primary/20/20 flex items-center justify-center mb-6">
        ...
        <div className="w-full space-y-3">
          <button
            ...
            className="w-full flex items-center justify-between px-5 py-4 rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 hover:border-primary transition-colors"
          >
